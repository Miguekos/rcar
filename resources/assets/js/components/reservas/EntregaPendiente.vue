      ...
      <v-card style="">
        ...
        <v-card-text>
          <v-container fluid="fluid" grid-list-xl="grid-list-xl">
            <v-layout row>
              <v-flex xs4>
                <v-subheader>Kilometro de entrega</v-subheader>
              </v-flex>
              <v-flex xs8>
                <v-text-field
                  solo
            ...
            <v-layout row>
              <v-flex xs4>
                <v-subheader>Comentario</v-subheader>
              </v-flex>
              <v-flex xs8>
                <v-textarea
                  solo
        ...
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 1}`" class="mx-auto">
                ...
                <v-card-title primary-title>
                  <v-layout align-center justify-space-around row fill-height>
                    ...
                    <div>
                      ...
                      <div class="text-xs-left"><strong>Direccion: </strong> {{ props.item.direccionEntrega }}</div>
                      <div class="text-xs-left"><strong>Vehiculo: </strong> {{ props.item.autoSeleccionado }}</div>
                    </div>
                    <!-- <div>
            ...
            <v-card-actions>
              ...
              <v-spacer></v-spacer>
              <v-btn @click="entregarV(props.item)" small color="primary">Entregar</v-btn>
