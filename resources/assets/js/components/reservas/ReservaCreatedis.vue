    ...
    <v-layout align-start="align-start" justify-space-between="justify-space-between" row="row" wrap="wrap" fill-height="fill-height">
      <v-flex xs12="xs12" lg6="lg6" elevation-3="elevation-3">
        <v-card-text>
          ...
          <v-menu :close-on-content-click="false" v-model="menu1" :nudge-right="40" lazy="lazy" transition="scale-transition" offset-y="offset-y" full-width="full-width" min-width="290px">
          ...
          <v-menu :close-on-content-click="false" v-model="menu2" :nudge-right="40" lazy="lazy" transition="scale-transition" offset-y="offset-y" full-width="full-width" min-width="290px">
          ...
          <v-autocomplete :items="auto" item-text="marca" item-value="id" @change="verAuto()" v-model="vehiculoId" placeholder="Select..." required="required" solo="solo"></v-autocomplete>
          <label>Cliente</label>
          <v-autocomplete @click:append-outer="dialog5 = true" append-outer-icon="add" :items="cliente" item-text="nombres" item-value="id" @change="verCliente()" v-model="clienteId" placeholder="Select..." required="required" solo="solo"></v-autocomplete>
          ...
          <label>Paquete</label>
          <v-autocomplete :items="promo" item-text="nombre" item-value="id" @change="verPromo()" v-model="promoId" placeholder="Select..." required="required" solo="solo"></v-autocomplete>
          ...
          <v-layout align-center="align-center" justify-space-between="justify-space-between" row="row" fill-height="fill-height">
            ...
            <v-flex xs12="xs12" sm3="sm3" lg3="lg3">
              ...
              <v-text-field readonly="readonly" v-model="diasd"></v-text-field>
            </v-flex>
          </v-layout>
          <v-divider></v-divider>
