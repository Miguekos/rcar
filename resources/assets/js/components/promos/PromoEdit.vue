            ...
            <form id="ContactForm" @submit.prevent="update">
                        <div class="form-group">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" required :value="cliente.nombre" autofocus name="nombres" placeholder="">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="telf">DNI</label>
                                <input type="text" class="form-control" required :value="cliente.vigencia" name="vigencia" placeholder="">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="direccion">Direccion</label>
                                <input type="text" class="form-control" required :value="cliente.dias_pagados" name="dias_pagados" placeholder="">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="dni">Telf</label>
                                <input type="text" class="form-control" required :value="cliente.dias_libres" name="dias_libres" placeholder="">
                            </div>
